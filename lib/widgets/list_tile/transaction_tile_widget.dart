...
class TransactionTileWidget extends StatefulWidget {
  const TransactionTileWidget(
      {super.key, this.inDashboard = true, this.transaction, required this.onTap, required this.expansion});
                ...
                children: [
                  ...
                  widget.transaction!.transactionType == "MONEY-EXCHANGE"
                      ? TextValueFormWidget(
                          ...
                          value: makeMultiplyBalance(widget.transaction!.senderRequestAmount.toString(), widget.transaction!.exchangeRate.toString()),
                  ...
                  TextValueFormWidget(
                    ...
                    value: makeBalance(widget.transaction!.senderRequestAmount.toString()),
                    currency: widget.transaction!.senderCurrencyCode,
                  ),
                  _divider(),

                  Visibility(
                    visible: widget.transaction!.transactionType == "MONEY-EXCHANGE",
                    child: Column(
                      children: [
                        TextValueFormWidget(
                  ...
                  TextValueFormWidget(
                    ...
                    currency: widget.transaction!.transactionType == "MONEY-EXCHANGE" ? widget.transaction!.senderCurrencyCode: widget.transaction!.gatewayCurrencyCode,
                  ),
                  _divider(),
                  TextValueFormWidget(
